...
class player extends base
	...
	get_definition_name: () -> 'network.game_master.player'
...
class connection_info extends base
	...
	get_definition_name: () -> 'network.game_master.connection_info'
...
class game_stats_bucket extends base
	...
	get_definition_name: () -> 'network.game_master.game_stats_bucket'
...
class game_factory_description extends base
	...
	get_definition_name: () -> 'network.game_master.game_factory_description'
...
class game_handle extends base
	...
	get_definition_name: () -> 'network.game_master.game_handle'
