...
class create_channel_request extends base
	...
	get_definition_name: () -> 'network.party.create_channel_request'
		
class create_channel_response extends base
	constructor: (params) ->
		super(params)
		
	get_definition_name: () -> 'network.party.create_channel_response'
		
class join_channel_request extends base
	constructor: (params) ->
		super(params)
		
	get_definition_name: () -> 'network.party.join_channel_request'
		
class join_channel_response extends base
	constructor: (params) ->
		super(params)
		
	get_definition_name: () -> 'network.party.join_channel_response'
		
class get_channel_info_response extends base
	constructor: (params) ->
		super(params)
		
	get_definition_name: () -> 'network.party.get_channel_info_response'
