...
class execute_request extends base
	constructor: (params) ->
		...
		@name = 'network.storage.execute_request'
	
class open_table_request extends base
	constructor: (params) ->
		super(params)
		
		@name = 'network.storage.open_table_request'
	
class open_column_request extends base
	constructor: (params) ->
		super(params)
		
		@name = 'network.storage.open_column_request'

class execute_response extends base
	constructor: (params) ->
		super(params)
		
		@name = 'network.storage.execute_response'
	
class open_table_response extends base
	constructor: (params) ->
		super(params)
		
		@name = 'network.storage.open_table_response'
	
class open_column_response extends base
	constructor: (params) ->
		super(params)
		
		@name = 'network.storage.open_column_response'
	
class operation_result extends base
	constructor: (params) ->
		super(params)
		
		@name = 'network.storage.operation_result'
	
class cell extends base
	constructor: (params) ->
		super(params)
		
		@name = 'network.storage.cell'
