...
CPPPATH_PROTOBUF = ['/usr/local/include']
CPPPATH_ST = '-I%s'
CXX = ['/usr/bin/g++']
CXXDEFINES_ST = '-D%s'
CXXFLAGS = ['-g', '-O3']
...
LIBDIR = '/Users/ericmuyser/.node_libraries'
LIBPATH_NODE = '/usr/local/lib'
LIBPATH_PROTOBUF = ['/usr/local/lib']
LIBPATH_ST = '-L%s'
LIB_PROTOBUF = ['protobuf']
LIB_ST = '-l%s'
LINKFLAGS = ['-undefined', 'dynamic_lookup', '-D_GLIBCXX_FULLY_DYNAMIC_STRING']
LINKFLAGS_MACBUNDLE = ['-bundle', '-undefined', 'dynamic_lookup']
LINK_CXX = ['/usr/bin/g++']
NODE_PATH = '/Users/ericmuyser/.node_libraries'
PREFIX = '/usr/local'
